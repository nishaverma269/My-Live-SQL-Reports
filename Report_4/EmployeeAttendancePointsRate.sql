...
From
  ...
  (Select A.Points as Points,
          ...
          Where A.PUN = B.Plexus_User_No
            ...
            AND A.Point_Date Between @StartDate AND @EndDate
            --AND A.Point_Date Between '12/01/18' AND '1/1/2019'
  ...
  (Select A.Points as Points,
          ...
          Where A.PUN = B.Plexus_User_No
            ...
            AND B.Employee_Status = 'Active'
            AND A.Point_Date Between @StartDate AND @EndDate
            --AND A.Creation_Date Between '12/01/18' AND '1/1/2019'
